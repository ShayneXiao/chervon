...
public class JwtTokenUtil implements Serializable {
    ...
    private Boolean isCreatedBeforeLastPasswordReset(Date created, Date lastPasswordReset) {
        System.out.println(lastPasswordReset != null && created.before(lastPasswordReset));
    ...
    public String generateToken(Mobile_User userDetails, Device device) {
    ...
    public Boolean validateToken(String token, Mobile_User userDetails) {
        JwtUser jwtUser = JwtUserFactory.create(userDetails);
        final String email = getEmailFromToken(token);
        final Date created = getCreatedDateFromToken(token);
        //final Date expiration = getExpirationDateFromToken(token);
        return (
                email.equals(jwtUser.getEmail())
